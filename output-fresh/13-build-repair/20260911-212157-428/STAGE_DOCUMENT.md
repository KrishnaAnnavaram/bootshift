...
| Edge | `EDGE-2-PATCH` |
| Status | **SUCCESS** |
| Start | 2026-09-11T21:21:57.209499500Z |
| End | 2026-09-11T21:22:44.201425200Z |
| Duration | 47.0 s |
...
| --- | --- | --- | --- |
| `RPR-001` | SUCCESS | 190 ms | Upstream inputs resolved |
| `RPR-002` | SUCCESS | 46.8 s | Completed; the stage reported SUCCESS |
| `RPR-003` | SUCCESS | 4 ms | Published and pointer advanced |

## 8. Tools and commands executed

| Id | Command | Exit | Timed out | Duration | Result |
| --- | --- | --- | --- | --- | --- |
| `CMD-000380` | `C:\Users\annav\tools\jdk-17\bin\java.exe -version` | 0 | no | 149 ms | SUCCESS |
| `CMD-000381` | `C:\Users\annav\AppData\Local\Temp\bootshift-workspaces\RUN-01M293KJ0RYV603B3JB0CCJJN9\migration\configuaration-server\mvnw.cmd -B -version` | 0 | no | 452 ms | SUCCESS |
| `CMD-000382` | `C:\Users\annav\AppData\Local\Temp\bootshift-workspaces\RUN-01M293KJ0RYV603B3JB0CCJJN9\migration\configuaration-server\mvnw.cmd -B -DskipTests test-compile` | 0 | no | 6.6 s | SUCCESS |
| `CMD-000383` | `C:\Users\annav\AppData\Local\Temp\bootshift-workspaces\RUN-01M293KJ0RYV603B3JB0CCJJN9\migration\configuaration-server\mvnw.cmd -B -DskipTests test-compile` | 0 | no | 9.1 s | SUCCESS |
| `CMD-000384` | `C:\Users\annav\AppData\Local\Temp\bootshift-workspaces\RUN-01M293KJ0RYV603B3JB0CCJJN9\migration\configuaration-server\mvnw.cmd -B -DskipTests test-compile` | 0 | no | 3.7 s | SUCCESS |
| `CMD-000385` | `C:\Users\annav\AppData\Local\Temp\bootshift-workspaces\RUN-01M293KJ0RYV603B3JB0CCJJN9\migration\configuaration-server\mvnw.cmd -B -DskipTests test-compile` | 0 | no | 12.6 s | SUCCESS |
| `CMD-000386` | `C:\Users\annav\AppData\Local\Temp\bootshift-workspaces\RUN-01M293KJ0RYV603B3JB0CCJJN9\migration\configuaration-server\mvnw.cmd -B -DskipTests test-compile` | 0 | no | 10.1 s | SUCCESS |
| `CMD-000387` | `C:\Users\annav\AppData\Local\Temp\bootshift-workspaces\RUN-01M293KJ0RYV603B3JB0CCJJN9\migration\configuaration-server\mvnw.cmd -B -DskipTests test-compile` | 0 | no | 3.9 s | SUCCESS |
...
| Artifact | SHA-256 |
| --- | --- |
| `build-report.json` | `5fa2deb696f46e20…` |
| `repair-report.json` | `699edf1399032f69…` |
| `diagnostics.json` | `11120f98393a54df…` |
| `manifest.json` | `a4d6fbc140a95e0c…` |

Attempt directory: `20260911-212157-428`

## 21. Result

**SUCCESS** — Edge EDGE-2-PATCH compiles after 1 round(s); 0 AI attempt(s) used of 12
...
| Attempt id | `01M295JFES4Y2QK2ZT64KF4PBB` |
| Stage id | `13-build-repair` |
| Edge id | `EDGE-2-PATCH` |
| Generated from | `stage-execution.json` |
| Execution record SHA-256 | `15b57159fac1a7a71d51299baeb0b97215d3680212bc834d5567cf8b122d1895` |
| Primary artifact hash | `-1823778831` |
